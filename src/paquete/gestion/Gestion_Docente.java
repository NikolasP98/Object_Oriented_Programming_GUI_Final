 ...
 * @author Nikolas
 */
public class Gestion_Docente {
    private Docente[] arreglo;
    ...
    */
    ...
    public Gestion_Docente() {
        arreglo = new Docente[100];
        contador = 0;
    }
    ...
    public Docente[] getArreglo() {
        return arreglo;
    }

    public void setArreglo(Docente[] arreglo) {
